//
//  ProductoSePuedeComprarCollectionViewController.swift
//  com.randomName
//
...
class ProductoSePuedeComprarCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        items.append(ItemModel.init(image: "CineColombia", title: "Cine Colombia", subtitle: "Disfruta de un buen rato de cine"))
        items.append(ItemModel.init(image: "Rappi", title: "Rappi", subtitle: ""))
        items.append(ItemModel.init(image: "Uber", title: "Viaja de la mano con ScotiaBank", subtitle: ""))
