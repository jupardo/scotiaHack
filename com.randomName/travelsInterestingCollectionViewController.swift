//
//  travelsInterestingCollectionViewController.swift
//  com.randomName
//
...
class travelsInterestingCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        items.append(ItemModel.init(image: "MadridEspania", title: "Madrid", subtitle: "Un paso más cerca con tus ScotiaPoints"))
        items.append(ItemModel.init(image: "USA", title: "Estados Unidos", subtitle: "Vive la aventura americana"))
        items.append(ItemModel.init(image: "Disneyland", title: "Disneyland", subtitle: "No permitas que te cuenten la experiencia"))
