//
//  travelsSePuedeComprarCollectionViewController.swift
//  com.randomName
//
...
class travelsSePuedeComprarCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        items.append(ItemModel.init(image: "SofitelHotel", title: "Hotel Sofitel", subtitle: "Cartagena"))
        items.append(ItemModel.init(image: "SanAndresHotel", title: "Hotel", subtitle: "San Andrés islas"))
        items.append(ItemModel.init(image: "CancunHotel", title: "Hotel", subtitle: "Cancún"))
